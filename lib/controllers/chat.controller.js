...
function postChat(req, res) {
  return _promise2.default.resolve(_shuttle2.default.liftRequest(req)).then(_shuttle2.default.liftFunction(_chat.createChat, 'data')).then((0, _tael.SendSuccess)(res)).catch((0, _tael.SendError)(res));
}